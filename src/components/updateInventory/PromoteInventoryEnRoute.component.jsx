...
export default class PromoteInventoryEnRouteComponent extends React.Component {
    constructor() {
        super()
        this.state = {
            preInventory: [],
    ...
    promotePreInventory = () => {
        ...
        axios.put(url.url + "/promoteInventoryEnRoute", preInventoryToBeUpdated)
            .then(result => {
                console.log('result of promoted Inventory En Route is:', result)
    ...
    render() {
        return <div className='row'>
            <div className='col-8'>
                <div className='card'>
                    <div className='card-header bg-success'>
                        <h4> Current Items in Inventory En Route State <button className='btn btn-dark btn-rounded' onClick={this.reGetPreInventory}> Refresh List</button> </h4>
            ...
            <div className='col-4'>
                <div className='card'>
                    <div className='card-header bg-success'>
                        <h6>Items to be Promoted From Inventory En Route State to Inventory .</h6>
                        <button className='btn btn-primary' onClick={this.promotePreInventory}>Move Items From Inventory En Route to Inventory</button>
                    </div>
