...
export default class AddToInventoryEnRouteComponent extends React.Component {
    ...
    saveToDatabase = () => {
        ...
        axios.post(url.url + "/saveInventoryEnRoute", supposedInventory)
            .then(result => {
                console.log(result)
                alert("item inserted")
                this.setState({
        ...
        return <form onSubmit={this.addItem}>
            <div className='row mx-3'>
                <div className='col-5 card'>
                    ...
                    <div className='card-header bg-success'> Adding to Invenotry En Route.These are items that are being shipped.</div>
                    <div className='row'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-8'>
                            <select className="form-control" name='itemType' value={this.state.itemType} onChange={this.handleChange} required >
                                ...
                                <option value="Power Cable">Speaker</option>
                ...
                <div className='col-7 card'>
                    <table>
                        <thead className='card-header bg-success'>
                            <tr>
                                <th><h4>Items to be Added to Inventory En Route</h4> </th>
                                <th>
